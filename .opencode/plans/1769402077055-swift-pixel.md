...
5. Templates list page `(internal)/templates`
6. Create template dialog
7. Template editor page with React Flow
8. Template task node component

### Phase 3: Project Integration

9. `createFromTemplate` mutation in projects.ts
10. Update project creation dialog with template selector
11. "Save as Template" from project settings

### Phase 4: Workspace Templates

12. Add workspace scope support to backend
13. Workspace templates page
14. "Copy to Workspace" for global templates
...
2. **Visual test**: Create template → add tasks → connect dependencies → create project → verify tasks + edges created
3. **Permission test**: Non-admin cannot edit global template, can copy to workspace
4. **E2E**: Full flow from template creation to project scaffolding
