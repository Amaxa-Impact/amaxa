import { TaskStatus } from '@amaxa/db/schema'
import { Button } from '@amaxa/ui/button'
import { Card, CardHeader, CardTitle, CardContent } from '@amaxa/ui/card'
...
export default function EditNode(props: {
  ...
  changeNode: (id: string, data: { title: string, description: string, status: TaskStatus }) => void,
  data: {
    id: string,
    title: string,
    description: string,
  ...
  return <Card className='w-min-[400px] h-min-[200px]'>
    <CardHeader>
      <CardTitle>
        Edit Task
      </CardTitle>
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea id="description" name="description" defaultValue={data.description as string} />
          </div>
          <div>
