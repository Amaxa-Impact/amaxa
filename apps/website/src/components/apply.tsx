  ...
  if (variant === "color") {
    return (
      <button
        ...
        className="inline-flex items-center px-5 sm:px-6 md:px-8 py-2 md:py-3 rounded-[3rem] border-[1px] border-[#3B3B3B] bg-[#b9d66e] text-[#3B3B3B] font-light hover:bg-[#a8c55f] transition-colors text-sm md:text-base "
