...
>
  <div
    className={cn(
      "bg-gradient-to-b from-neutral-50 to-neutral-200 bg-clip-text text-xl font-medium text-transparent transition-all duration-300 md:text-md",
      hovered === index && "text-black bg-none", // or whatever hover effect you want
    )}
  >

    <p className="font-light text-xl">     {card.title}</p>
