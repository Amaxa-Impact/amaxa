      ...
      <div className="w-full lg:w-1/2 mb-10 lg:mb-0 lg:pr-8">
        <div className="max-w-xl mx-auto lg:mx-0">
          ...
          <div className="flex flex-wrap gap-3 md:gap-4 pt-4 md:pt-8">
            ...
            <Link
              href="/project"
              className="inline-flex items-center px-5 sm:px-6 md:px-8 py-2 md:py-3 rounded-full border-[1px] border-[#3B3B3B] text-[#3B3B3B] font-medium hover:bg-gray-100 transition-colors text-sm md:text-base"
            >
