...
export default function WhoAreWePage() {
  return (
     <main className="w-full">
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-6 md:px-16 lg:px-20 py-16 text-[#3B3B3B]">
        <div className="h-[400px] w-full flex items-center justify-center relative overflow-hidden bg-black">
          <motion.img
            src=""
          ...
          />
          <h1 className="text-3xl font-bold text-left text-white relative z-10 max-w-4xl px-6 ">
            Àmaxa’s mission is to make it easier for people who want to make a difference to <ColourfulText text="actually take action" /> — not just feel stuck in that “I want to help, but I don’t know how” feeling.
          </h1>
        </div>
      </section>
      ...
      {/* About Section */}
      <section className="max-w-7xl mx-auto px-6 md:px-16 lg:px-20 py-16 text-[#3B3B3B]">
        <h3 className="text-3xl md:text-4xl lg:text-5xl font-normal mb-8">
          ámaxa takes chance out of making change.        
          </h3>
        <p className="mb-6 text-lg max-w-4xl">
1. Through Ámaxa Pathways, we match you to a project with a clear goal at one of our 9 partner nonprofits & initiatives, a team of passionate peers, and a trained coach. The program is 100% remote.        </p>
        <p className="mb-6 text-lg max-w-4xl">
            2. Then, over 3 months, you meet weekly on Zoom to plan & accomplish your project in the way that best highlights your team’s passions & strengths.
        </p>
           <p className="mb-6 text-lg max-w-4xl">
3. Along the way, you implement project management methodologies designed specifically for ámaxa projects & utilize the tools and resources in our custom online platform.        </p>
      </section>

      {/* Pathways Intro */}
      <section className="max-w-7xl mx-auto px-6 md:px-16 lg:px-20 py-16">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal text-[#3B3B3B] max-w-5xl">
          Explore the ámaxa pathway for you.
        </h2>
      </section>

      {/* Pathways Cards */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto px-6 md:px-16 lg:px-20">
...
Ámaxa Cohorts, for high school students </h2>
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
           Through our 3-month remote program, students work in a remote team of your peers, guided by a coach, to effect measurable change through one of our 9 partner nonprofits or original initiatives.
          </p>
          <img
          ...
          className="absolute -right-10 md:-right-[70%] lg:-right-[30%] -bottom-40 object-contain rounded-2xl"
          />
      ...
      <WobbleCard containerClassName="col-span-2 lg:col-span-1 min-h-[320px]">
          <h2 className="max-w-sm md:max-w-lg text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
Ámaxa Research
for: undergrad & postgrad students
</h2>
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
Ámaxa Research’s mission is to conduct, write, and publish original research on questions critical to the work of our partner nonprofits and initiatives.         </p>
        <img
          src="https://b47pkz22xs.ufs.sh/f/OxFTTzjZGToOjxcCpDmYZFtMKdGCwhkEePg27zV39qyDB0mr"
          width={500}
          height={500}
          alt="linear demo image"
          className="absolute -right-10 md:-right-[70%] lg:-right-[10%] -bottom-40 object-contain rounded-2xl"
        />
      </WobbleCard>
      </Link>
...
Ámaxa Partnerships, for professionals
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
      The model of Ámaxa Partnerships recognizes that the greatest capacity for tangible change professionals possess is the ability to raise funds through corporate partnerships and donations via each of our networks. 
          </p>
           <img
          ...
          height={450}
          alt="linear demo image"
          className="absolute -right-20 md:-right-[70%] lg:-right-[2%] -top-[20%] object-contain rounded-2xl -z-10"
        />
      </WobbleCard>
      </Link>
...
Ámaxa Network, for Coloradans
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
An open invitation for individuals in Colorado who are doing great things to effect change and space to congregate both digitally & in-person</p>
        </div>
          <img
          ...
          height={500}
          alt="linear demo image"
          className="absolute -right-10 md:-right-[70%] lg:-right-[10%] -bottom-20 object-contain rounded-2xl"
        />
      </WobbleCard>
        </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-20 py-8 space-y-10">
        <p className="text-neutral-500 dark:text-neutral-400 text-lg md:text-xl max-w-3xl">
          Created an
          <LinkPreview
...
...
      ...
      <section className="bg-[#F5F2F2] py-16 md:py-24 lg:py-32">
        <div className="px-6 md:px-16 lg:px-20">
          <h2 className="mb-12 max-w-5xl text-3xl md:text-4xl lg:text-5xl font-normal leading-tight text-[#3B3B3B]">
      ...
      <motion.img
        ...
        transition={{ duration: 1 }}
      />
      <h1 className="text-4xl w-[1000px] font-bold text-center text-white relative z-2">
       Àmaxa’s mission is to make it easier for people who want to make a difference to <ColourfulText text="actually take action" /> — not just feel stuck in that “I want to help, but I don’t know how” feeling.
      </h1>
    </div>
     ...
     <section className="w-full py-16 md:py-24">
         <div className="">
          <h2 className="max-w-5xl text-3xl font-normal leading-tight text-[#3B3B3B] md:text-4xl lg:text-5xl">
            So, we aim to take care of every aspect of what stops people- when you have that “but how do I start feeling”- the right nonprofit to help, who will do it with you, someone to guide you, and how to manage the project, all remotely.
          </h2>   
        </div>
    </section>
     ...
     <div className="grid grid-cols-2 gap-4 max-w-7xl mx-auto w-full">
      <p className="mb-6 text-lg">
                                {" "}
                                Our first pathway launched in 2023 for high school students. We match each student with one of our nonprofit partners- working in areas like education, mental health, refugee support, and more- a small team of peers, and a trained coach. Over three months, they meet weekly over Zoom and work together on a project—some have created educational platforms for students in Palestine, planted trees across three countries, raised funds for medical aid in Ukraine, paid tuition for Liberian students, and more. A core part of our mission is accessibility: the program is 100% remote and scholarship-backed, so any student who wants to make a difference can do so, regardless of financial background. 
                              </p>
